...
The eigenray paths are typically included in the arrivals. However, if they are
not needed, one may set `paths=false` to allow the propagation model to avoid
computing them.
"""
